...
```javascript
import constants from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-array@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { MAX_ARRAY_LENGTH, MAX_TYPED_ARRAY_LENGTH } from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-array@v0.2.3-deno/mod.js';
```
